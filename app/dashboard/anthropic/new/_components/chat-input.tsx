...
export function ChatInput() {
  return (
    <div className="flex flex-col gap-4 w-full py-28 items-center">
      {/* logo image */}
      <Loader className="size-8 shrink-0" />
        ...
        <InputGroupAddon align="block-end" className="justify-between">
          ...
          <div className="flex flex-row items-center gap-2">
            ...
            <InputGroupButton
              variant="default"
              size="icon-sm"
              className="bg-orange-400/60 text-foreground hover:bg-orange-400/80"
            >
