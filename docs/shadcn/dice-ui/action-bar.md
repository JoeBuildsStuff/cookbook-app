...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="yarn">
    ```bash
    yarn dlx shadcn@latest add "@diceui/action-bar"
  ...
  <CodeBlockTab value="bun">
    ```bash
    bun x shadcn@latest add "@diceui/action-bar"
...
<Steps>
  <Step>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="npm">
        ```bash
        npm install @radix-ui/react-slot @radix-ui/react-direction
        ```
      </CodeBlockTab>

      <CodeBlockTab value="pnpm">
        ```bash
        pnpm add @radix-ui/react-slot @radix-ui/react-direction
        ```
      </CodeBlockTab>

      <CodeBlockTab value="yarn">
        ```bash
        yarn add @radix-ui/react-slot @radix-ui/react-direction
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun add @radix-ui/react-slot @radix-ui/react-direction
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
  </Step>
...
<AutoTypeTable path="./types/docs/action-bar.ts" name="ActionBarSelectionProps" />
...
<AutoTypeTable path="./types/docs/action-bar.ts" name="ActionBarSeparatorProps" />
